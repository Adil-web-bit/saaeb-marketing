    ...
    ar: {
        ...
        home: {
            ...
            howSteps: [
                {
                    number: '01',
                    title: 'مسؤولون تنفيذيون سابقون في شركات التأمين',
                    description: 'يتألف فريقنا الأساسي من خبراء كانوا سابقاً يكتبون قواعد الرفض داخل شركات التأمين الكبرى. نقوم بعكس منطقهم لضمان قبول مطالباتكم.',
                },
                {
                    number: '02',
                    title: 'مجلس المراجعة السريرية',
                    description: 'لحالات معقدة للغاية، يوفر فريقنا المتكامل من المهنيين الطبيين والرمّوز الماهرين طبقة بشرية من المراجعة السريرية، ويعد مبررات طبية لا يمكن دحضها قبل الإرسال.',
            ...
            ctaButton: 'احجز تدقيق رفض مجاني',
        },
